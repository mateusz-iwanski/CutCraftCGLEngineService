...
namespace CutCraftCGLEngineService.CGLCalculator
{
    ...
    /// </summary>
    public static class CGLCutEnginePropertiesSetup
    {
        /// <summary>
        ...
        public static void SetProperties(this CutEngine cutEngine, Command command, int deviceId, double kerf)
        {
            ...
            /// </summary>
            double minWaste;
            double.TryParse(switchToSmall.minWaste.Replace("%", ""), out minWaste);
            cutEngine.WasteSizeMin = switchToSmall.enabled == true ? minWaste : 0.0d;
